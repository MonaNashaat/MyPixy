...
extends DepClient {
	...
	public XPathAnalysis(DepAnalysis depAnalysis) {
		super(depAnalysis);
	...
	public List<Integer> detectVulns() {
		...
		//System.out.println();
		//System.out.println("*****************");
		//System.out.println("XPath BEGIN");
		//System.out.println("*****************");
		//System.out.println();
		...
		try{
			...
			System.out.println("Creating XPath Injection Analysis Report");
			bw.append("<p class=\"title\">XPath Injection Analysis Report</p>");
			...
			for (Sink sink : sinks) {
				...
				for (DepGraph depGraph : depGraphs) {
					...
					String graphNameBase = "xpath_" + fileName + "_" + graphcount;
					...
					if (tainted) {
						...
						bw.append("<tr>");
						bw.append("<td>XPath Injection</td>");
						...
						if (!dangerousUninit.isEmpty()) {
							...
							//bw.newLine();
							bw.append("<td>xpath"+graphcount+"</td>");
			...
			//System.out.println();
			//System.out.println("*****************");
			//System.out.println("XPath Analysis END");
			//System.out.println("*****************");
			//System.out.println();
			bw.append("<tfoot>"+
			"<tr>"+
