...
//  ********************************************************************************
	...
	public Set<Variable> getGlobalMayAliases(Variable var, CfgNode cfgNode) {
        Set<Variable> mayAliases = this.getMayAliases(var, cfgNode);
        Set<Variable> retMe = new HashSet<Variable>();
        for (Iterator<Variable> iter = mayAliases.iterator(); iter.hasNext();) {
            Variable mayAlias = iter.next();
